...
module List where
  ...
  of-list : ∀ {n} → Data.List.List ℕ → val (list n nat)
  of-list []       = nil
  of-list (x ∷ xs) = cons (tonat x) (of-list xs)
